...
export function SearchForm({
  ...
  const getInputClasses = () => {
    if (variant === 'shadcn') {
      return cn(
        'flex h-fit w-full rounded-md rounded-l-none border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
        {
    ...
    // التصميم الافتراضي
    return cn(
      'w-full md:w-[80%] h-18 md:rounded-lg md:rounded-l-none text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 focus:ring-2 focus:ring-primary focus:border-primary dark:focus:border-primary',
      {
  ...
  const getButtonClasses = () => {
    if (variant === 'shadcn') {
      return cn(
        'inline-flex items-center justify-center rounded-md rounded-r-none text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90',
        {
    ...
    // التصميم الافتراضي
    return cn(
      'bg-primary w-full md:w-[20%] hover:bg-primary/90 text-white font-medium md:rounded-lg md:rounded-r-none transition-colors h-fit',
      {
          ...
          <div className="relative flex-grow mb-2 sm:mb-0">
            ...
            {isLoading ? (
              ...
              <button
                ...
                onClick={clearSearch}
                className={cn(
                  "absolute top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 h-fit",
