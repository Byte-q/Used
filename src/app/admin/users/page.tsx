...
export default function UsersManagement() {
  ...
  const handleDelete = async (id: number) => {
    ...
    response.success === true ? router.refresh() : '';
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link 
              ...
              className="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-200 dark:bg-gray-500 hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors"
            >
                  ...
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                    <button
                      ...
                      className={`relative inline-flex items-center px-4 py-2 border ${
                        currentPage === page
                          ? 'bg-gray-200 text-white border-primary dark:bg-gray-500 dark:text-white dark:border-primary'
